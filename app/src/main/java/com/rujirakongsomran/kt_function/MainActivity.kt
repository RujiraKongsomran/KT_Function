package com.rujirakongsomran.kt_function
...
class MainActivity : AppCompatActivity() {
    ...
    fun divide2number(a: Float, b: Float): Float {
        if (b != 0f) {
            return a / b;
        } else {
            return 0f;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnMinus.setOnClickListener {
            Toast.makeText(
                this,
                "" + minus2number(etNum1.text.toString().toInt(), etNum2.text.toString().toInt()),
                Toast.LENGTH_SHORT
            ).show()
        }
        ...
        btnMulti.setOnClickListener {
            Toast.makeText(
                this,
                "" + multi2number(etNum1.text.toString().toInt(), etNum2.text.toString().toInt()),
                Toast.LENGTH_SHORT
            ).show()
        }
